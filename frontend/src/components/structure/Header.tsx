...
export default function Header() {
	...
	return (
		<div className="flex-1 px-8 bg-brand-primary inline-flex justify-start items-start">
			<div className="pr-8 py-8 inline-flex flex-col justify-start items-start gap-2.5 cursor-pointer">
				<Icon name="logo" />
			</div>
			{isAuthenticated && (
				<div className="flex-1 self-stretch py-4 inline-flex flex-col justify-start items-start gap-2.5 overflow-hidden">
					<div className="self-stretch flex-1 pl-4 bg-white inline-flex justify-start items-center overflow-hidden">
						<input className="flex-1 h-full outline-none border-none text-2xl font-bold font-['Inter']" placeholder="Szukaj..." />
			...
			{isAuthenticated && (
				<div className="self-stretch flex justify-start items-center">
					...
					<div className="self-stretch justify-start items-center px-2 gap-2 pt-2 cursor-pointer hover:bg-[rgba(255,255,255,0.1)]">
						<div className="justify-start text-white text-2xl font-bold font-['Inter'] underline">Dawid Lipiński</div>
			...
			{!isAuthenticated && (
				<div className="flex-1 self-stretch justify-end items-center ">
					<div className="self-stretch items-center p-2 text-white text-xl font-bold font-['Inter'] underline hover:bg-[rgba(255,255,255,0.1)] cursor-pointer" onClick={() => {router.push("/logowanie")}}>Zaloguj się</div>
				</div>
			)}
		</div>
	);
